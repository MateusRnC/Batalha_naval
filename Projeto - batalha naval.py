...
def telaApersentacao():
    while True:
	    ...
	    ent = input('Digite uma opção: ')
	    if ent == '1':
	    	limparTela()
	    	print("Preparado? Pressione Enter.")
	    	break
	    	
	    elif ent == '2':
	    	limparTela()
	    	print('INSTRUÇÕES:\n1. Cada jogador distribui seus barcos pelo tabuleiro. Isso é feito a partir de referências, como A4, por exemplo. "Seu jogo"\n2. Não é permitido que 2 barcos sejam posicionados um do lado do outro, nem mesmo em cima de outro.\n\nLEGENDAS DE SIMBOLOS E SUAS REPRESENTAÇÕES NO TABULEIRO:')
	    	...
	    	print('-' * 65)
	    	while True:
	    		voltar = input('Digite "S" ou pressione Enter para voltar\n').lower()
	    		if voltar == 's' or voltar == '':
	    			limparTela()
	    			break
	    			
	    elif ent == '3':
	    	confirmacao = input("Já vai embora? Fico triste com isso.\nInsira S para confirmar, ou qualquer outro botão para continuar batalhando.").lower()
	    	if confirmacao == 's':
	    		exit()
	    	else:
	    		limparTela()
	    	...
	    	limparTela()
	    	print("Opa! Opção inválida, insira 1 ou 2!")
